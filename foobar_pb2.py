...
_FOOBAR = _descriptor.ServiceDescriptor(
  name='Foobar',
  full_name='Foobar',
  file=DESCRIPTOR,
  index=0,
...
_sym_db.RegisterServiceDescriptor(_FOOBAR)

DESCRIPTOR.services_by_name['Foobar'] = _FOOBAR
